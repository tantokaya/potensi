...
<?php //echo form_open_multipart('search/detail/section/'.$section.'/'.$kategori.'/'.$lembaga, array('class'=>'form-horizontal form-bordered','id'=>'form','name'=>'form','method'=>'post')); ?>	 
<div class="lembaga">
...
<div class="info">
	 ...
	 Kata Kunci : <span class="key"><?php echo ucwords($key);?></span></br>
